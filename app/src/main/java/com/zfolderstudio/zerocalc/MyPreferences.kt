...
class MyPreferences(context: Context) {
    ...
    companion object {
        private const val THEME = "darkempire78.zerocalc.THEME"
        private const val FORCE_DAY_NIGHT = "darkempire78.zerocalc.FORCE_DAY_NIGHT"

        private const val KEY_VIBRATION_STATUS = "darkempire78.zerocalc.KEY_VIBRATION_STATUS"
        private const val KEY_HISTORY = "darkempire78.zerocalc.HISTORY_ELEMENTS"
        private const val KEY_PREVENT_PHONE_FROM_SLEEPING = "darkempire78.zerocalc.PREVENT_PHONE_FROM_SLEEPING"
        private const val KEY_HISTORY_SIZE = "darkempire78.zerocalc.HISTORY_SIZE"
        private const val KEY_SCIENTIFIC_MODE_ENABLED_BY_DEFAULT = "darkempire78.zerocalc.SCIENTIFIC_MODE_ENABLED_BY_DEFAULT"
        private const val KEY_RADIANS_INSTEAD_OF_DEGREES_BY_DEFAULT = "darkempire78.zerocalc.RADIANS_INSTEAD_OF_DEGREES_BY_DEFAULT"
        private const val KEY_NUMBER_PRECISION = "darkempire78.zerocalc.NUMBER_PRECISION"
        private const val KEY_WRITE_NUMBER_INTO_SCIENTIC_NOTATION = "darkempire78.zerocalc.WRITE_NUMBER_INTO_SCIENTIC_NOTATION"
        private const val KEY_LONG_CLICK_TO_COPY_VALUE = "darkempire78.zerocalc.LONG_CLICK_TO_COPY_VALUE"
        private const val KEY_ADD_MODULO_BUTTON = "darkempire78.zerocalc.ADD_MODULO_BUTTON"
        private const val KEY_SPLIT_PARENTHESIS_BUTTON = "darkempire78.zerocalc.SPLIT_PARENTHESIS_BUTTON"
        private const val KEY_DELETE_HISTORY_ON_SWIPE = "darkempire78.zerocalc.DELETE_HISTORY_ELEMENT_ON_SWIPE"
        private const val KEY_AUTO_SAVE_CALCULATION_WITHOUT_EQUAL_BUTTON = "darkempire78.zerocalc.AUTO_SAVE_CALCULATION_WITHOUT_EQUAL_BUTTON"
        private const val KEY_MOVE_BACK_BUTTON_LEFT = "darkempire78.zerocalc.MOVE_BACK_BUTTON_LEFT"
        private const val KEY_NUMBERING_SYSTEM = "darkempire78.zerocalc.NUMBERING_SYSTEM"
        private const val KEY_SHOW_ON_LOCK_SCREEN = "darkempire78.zerocalc.KEY_SHOW_ON_LOCK_SCREEN"
    }
