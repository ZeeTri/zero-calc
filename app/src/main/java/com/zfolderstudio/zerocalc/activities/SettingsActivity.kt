...
class SettingsActivity : AppCompatActivity() {
    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
            ...
            val appLanguagePreference = findPreference<Preference>("darkempire78.zerocalc.APP_LANGUAGE")
            ...
            // Theme button
            val appThemePreference = findPreference<Preference>("darkempire78.zerocalc.APP_THEME_SELECTOR")
            ...
            val appNumberingSystemPreference =
                findPreference<Preference>("darkempire78.zerocalc.NUMBERING_SYSTEM")
            ...
            val scientificModeTypesSystemPreference =
                findPreference<Preference>("darkempire78.zerocalc.SCIENTIFIC_MODE_ENABLED_BY_DEFAULT")
