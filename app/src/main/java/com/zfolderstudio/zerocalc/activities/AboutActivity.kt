...
import com.zfolderstudio.zerocalc.BuildConfig
...
import com.zfolderstudio.zerocalc.databinding.ActivityAboutBinding
...
class AboutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.aboutRate.setOnClickListener {
            val browserIntent = Intent(
                Intent.ACTION_VIEW,
                Uri.parse("https://play.google.com/store/apps/details?id=com.zfolderstudio.zerocalc")
            )
            startActivity(browserIntent)
        }
        ...
        binding.aboutGithub.setOnClickListener {
            val browserIntent = Intent(
                Intent.ACTION_VIEW,
                Uri.parse("https://github.com/Darkempire78/ZeroCalc")
            )
            startActivity(browserIntent)
        }
        ...
        binding.aboutPrivacyPolicy.setOnClickListener {
            val browserIntent = Intent(
                Intent.ACTION_VIEW,
                Uri.parse("https://gist.githubusercontent.com/Darkempire78/1688314e8b75d5d32ac0503a97ec77a0/raw/2dcc4cf13f9755405e486e51e4658626c289986a/ZeroCalc%2520Privacy%2520Policy.md")
            )
            startActivity(browserIntent)
        }
        ...
        binding.aboutLicense.setOnClickListener {
            val browserIntent = Intent(
                Intent.ACTION_VIEW,
                Uri.parse("https://github.com/Darkempire78/ZeroCalc/blob/main/LICENSE")
            )
            startActivity(browserIntent)
        }
